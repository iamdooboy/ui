...
export const CardHorizon = ({ children, className }: ExampleProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        'relative h-full w-full rounded-xl flex justify-center',
        className
      )}
    >
      <div className='absolute top-0 flex w-full justify-center items-center'>
        <div
          className={cn(
